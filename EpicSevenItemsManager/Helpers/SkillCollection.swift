...
public enum SkillCollection {
    ...
    // Holiday Yufine
    public static let justOneBite = Skill(skillName: Strings.justOneBite, description: Strings.justOneBiteDescription, initialCooldown: 0, initialEffectChance: 50, skillEnhancementEffects: [Strings.plusFivePercentDamageDealt, Strings.plusFivePercentEffectChance, Strings.plusTenPercentDamageDealt, Strings.plusTenPercentEffectChance, Strings.plusFifteenPercentDamageDealt], skillType: Strings.active)
    public static let letsEatTogether = Skill(skillName: Strings.letsEatTogether, description: Strings.letsEatTogetherDescription, initialEffectChance: 30, skillEnhancementEffects: [Strings.minusTwoPercentCombatReadiness, Strings.minusThreePercentCombatReadiness, Strings.minusFourPercentCombatReadiness, Strings.minusFivePercentCombatReadiness, Strings.minusSixPercentCombatReadiness], skillType: Strings.passive)
    public static let yufinesSpecial = Skill(skillName: Strings.yufinesSpecial, description: Strings.yufinesSpecialDescription, initialCooldown: 5, initialEffectChance: 0, skillEnhancementEffects: [Strings.plusFivePercentDamageDealt, Strings.plusFivePercentDamageDealt, Strings.minusSixPercentCombatReadiness, Strings.plusFivePercentDamageDealt, Strings.plusFifteenPercentDamageDealt], soulBurnEffect: Strings.minusTwoTurnCooldown, requiredFullSouls: 1)
    // Hwayoung
    public static let supersonicKick = Skill(skillName: Strings.supersonicKick, description: Strings.supersonicKickDescription, initialCooldown: 0, initialEffectChance: 0, skillEnhancementEffects: [Strings.plusFivePercentDamageDealt, Strings.plusFivePercentDamageDealt, Strings.plusFivePercentDamageDealt, Strings.plusFivePercentDamageDealt, Strings.plusTenPercentDamageDealt])
    public static let prairieHawk = Skill(skillName: Strings.prairieHawk, description: Strings.prairieHawkDescription, initialCooldown: 0, initialEffectChance: 20, skillEnhancementEffects: [Strings.plusOnePercentAttack, Strings.plusTwoPercentAttack, Strings.plusTwoPercentAttack, Strings.plusTwoPercentAttack, Strings.plusThreePercentAttack], skillType: Strings.passive)
    public static let emperorsFlamingStrike = Skill(skillName: Strings.emperorsFlamingStrike, description: Strings.emperorsFlamingStrikeDescription, initialCooldown: 5, initialEffectChance: 0, skillEnhancementEffects: [Strings.plusFivePercentDamageDealt, Strings.plusFivePercentDamageDealt, Strings.minusTwoTurnCooldown, Strings.plusTenPercentDamageDealt, Strings.plusTenPercentDamageDealt], soulBurnEffect: Strings.grantsExtraTurn, requiredFullSouls: 2)
