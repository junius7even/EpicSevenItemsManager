...
struct ContentView: View {
    ...
    @State var heroArray: [String] = [Strings.aria, Strings.cerise, Strings.choux, Strings.diene, Strings.dizzy, Strings.eda, Strings.elena, Strings.emilia, Strings.fairytaleTenebria, Strings.flan, Strings.alencia, Strings.baiken, Strings.basar, Strings.bellona, Strings.celine, Strings.charles, Strings.ervalen, Strings.bombModelKanna, Strings.cecilia, Strings.cermia, Strings.edward, Strings.elphelt, Strings.holidayYufine, Strings.ambitiousTywin, Strings.belian, Strings.commanderPavel, Strings.spiritEyeCeline, Strings.conquerorLilias, Strings.desertJewelBasar, Strings.faithlessLidica, Strings.apocalypseRavi, Strings.arbiterVildred, Strings.bloodMoonHaste, Strings.briarWitchIseria, Strings.closerCharles, Strings.designerLilibet, Strings.fallenCecilia]
