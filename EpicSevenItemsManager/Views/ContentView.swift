...
struct ContentView: View {
    ...
    @State var heroArray: [String] = [Strings.aria, Strings.cerise, Strings.choux, Strings.diene, Strings.dizzy, Strings.eda, Strings.elena, Strings.emilia, Strings.alencia, Strings.baiken, Strings.basar, Strings.bellona, Strings.celine, Strings.charles, Strings.ervalen, Strings.bombModelKanna, Strings.cecilia, Strings.cermia, Strings.edward, Strings.elphelt, Strings.ambitiousTywin, Strings.belian, Strings.commanderPavel, Strings.spiritEyeCeline, Strings.conquerorLilias, Strings.desertJewelBasar, Strings.apocalypseRavi, Strings.arbiterVildred, Strings.bloodMoonHaste, Strings.briarWitchIseria, Strings.closerCharles, Strings.designerLilibet]
